...
public class datatrainer extends JFrame {
    ...
    public datatrainer() {
        ...
        btnTambah.addActionListener(e -> loadData());
        btnUbah.addActionListener(e -> loadData());
    ...
    public void loadData() {
        model.setRowCount(0);
        String sql = "SELECT * FROM tb_trainer ORDER BY id_trainer";
    ...
    private void hapusData() {
        ...
        String namaTrainer = (String) model.getValueAt(row, 1);
        int id = (int) model.getValueAt(row, 0);

        int confirm = JOptionPane.showConfirmDialog(this,
            "Hapus trainer \"" + namaTrainer + "\"?\nSemua pokemon miliknya juga akan terhapus.",
